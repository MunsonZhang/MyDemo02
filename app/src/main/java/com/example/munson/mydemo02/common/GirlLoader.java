...
import com.example.munson.mydemo02.R;
import com.example.munson.mydemo02.helper.DiskCacheHelper;
import com.example.munson.mydemo02.helper.MemoryCacheHelper;
import com.example.munson.mydemo02.helper.NetworkHelper;
import com.example.munson.mydemo02.util.SizeUtils;
...
public class GirlLoader {
    ...
    public static GirlLoader getInstance(Context context) {
        return new GirlLoader(context);
    }

    private GirlLoader(Context context) {
